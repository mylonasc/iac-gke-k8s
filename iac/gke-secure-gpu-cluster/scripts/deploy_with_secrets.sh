...
PHASE_A_TARGETS=(
  ...
  "-target=google_service_account.backend_admin_gsa"
  "-target=google_secret_manager_secret_iam_member.backend_admin_secret_accessor"
  "-target=google_service_account_iam_member.workload_identity_user"
  "-target=google_service_account_iam_member.backend_admin_workload_identity_user"
  "-target=google_project_iam_member.backend_admin_service_account_admin"
  "-target=google_storage_bucket.sandbox_workspace"
  "-target=google_storage_bucket_iam_member.backend_admin_workspace_storage_admin"
  "-target=google_container_cluster.primary"
  "-target=google_container_node_pool.primary_nodes"
  "-target=google_container_node_pool.gvisor_pool"
