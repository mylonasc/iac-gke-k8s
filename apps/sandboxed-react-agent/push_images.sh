...
# docker.io/mylonasc/magarathea:sandboxed-react-agent-backend-0.6.23
# docker.io/mylonasc/magarathea:sandboxed-react-agent-frontend-0.5.16
DOCKER_REGISTRY="${DOCKER_REGISTRY:-docker.io}"
DOCKERHUB_NAMESPACE="${DOCKERHUB_NAMESPACE:-mylonasc}"
IMAGE_REPO="${IMAGE_REPO:-magarathea}"
BACKEND_TAG="${TAG:-0.6.23}"
FRONTEND_TAG="${TAG:-0.5.16}"
