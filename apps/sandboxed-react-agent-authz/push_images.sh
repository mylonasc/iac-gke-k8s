...
# docker.io/mylonasc/magarathea:sandboxed-react-agent-backend-0.6.21
...
BACKEND_TAG="${TAG:-0.1.0}"
FRONTEND_TAG="${TAG:-0.1.0}"

BACKEND_IMAGE="${DOCKER_REGISTRY}/${DOCKERHUB_NAMESPACE}/${IMAGE_REPO}:sandboxed-react-agent-authz-backend-${BACKEND_TAG}"
FRONTEND_IMAGE="${DOCKER_REGISTRY}/${DOCKERHUB_NAMESPACE}/${IMAGE_REPO}:sandboxed-react-agent-authz-frontend-${FRONTEND_TAG}"
